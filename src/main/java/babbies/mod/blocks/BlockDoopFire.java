...
public class BlockDoopFire extends BlockFire {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !((BlockDoopFire) ModBlocks.doopFire).canCatchFire(worldIn, pos.down(), EnumFacing.UP)) {
	...
	public BlockDoopFire(String unlocalizedName) {
		super();
	...
	public static void init() {
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.planks, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.double_wooden_slab, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.wooden_slab, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.oak_fence_gate, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.spruce_fence_gate, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.birch_fence_gate, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.jungle_fence_gate, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.dark_oak_fence_gate, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.acacia_fence_gate, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.oak_fence, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.spruce_fence, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.birch_fence, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.jungle_fence, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.dark_oak_fence, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.acacia_fence, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.oak_stairs, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.birch_stairs, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.spruce_stairs, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.jungle_stairs, 5, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.log, 5, 5);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.log2, 5, 5);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.leaves, 30, 60);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.leaves2, 30, 60);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.bookshelf, 30, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.tnt, 15, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.tallgrass, 60, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.double_plant, 60, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.yellow_flower, 60, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.red_flower, 60, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.deadbush, 60, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.wool, 30, 60);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.vine, 15, 100);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.coal_block, 5, 5);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.hay_block, 60, 20);
		((BlockDoopFire) ModBlocks.doopFire).setFireInfo(Blocks.carpet, 60, 20);
	}
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
		if (worldIn.provider.getDimensionId() > Leopold.doopDimID || !((BlockPortalDoop) ModBlocks.portalDoop).func_176548_d(worldIn, pos)) {
			if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !this.canNeighborCatchFire(worldIn, pos)) {
				worldIn.setBlockToAir(pos);
			}
			else {
	...
	public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !Blocks.fire.canCatchFire(worldIn, pos.down(), EnumFacing.UP)) {
			if (((BlockDoopFire) ModBlocks.doopFire).canCatchFire(worldIn, pos.west(), EnumFacing.EAST)) {
				for (i = 0; i < 2; ++i) {
			...
			if (((BlockDoopFire) ModBlocks.doopFire).canCatchFire(worldIn, pos.east(), EnumFacing.WEST)) {
				for (i = 0; i < 2; ++i) {
			...
			if (((BlockDoopFire) ModBlocks.doopFire).canCatchFire(worldIn, pos.north(), EnumFacing.SOUTH)) {
				for (i = 0; i < 2; ++i) {
			...
			if (((BlockDoopFire) ModBlocks.doopFire).canCatchFire(worldIn, pos.south(), EnumFacing.NORTH)) {
				for (i = 0; i < 2; ++i) {
					d0 = pos.getX() + rand.nextDouble();
					d1 = pos.getY() + rand.nextDouble();
			...
			if (((BlockDoopFire) ModBlocks.doopFire).canCatchFire(worldIn, pos.up(), EnumFacing.DOWN)) {
				for (i = 0; i < 2; ++i) {
					d0 = pos.getX() + rand.nextDouble();
	...
	protected BlockState createBlockState() {
		return new BlockState(this, new IProperty[] { AGE, NORTH, EAST, SOUTH, WEST, UPPER, FLIP,
				ALT });
	}
